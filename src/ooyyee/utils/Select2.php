...
class Select2
{
     ...
     */
    public static function data($table,$titleField='title',$database=[],$order=['id'=>'desc'],callable $whereCallback=null){
    ...
    public static function datas($table,$titleField='title',$database=[],$order=['id'=>'desc'],callable $whereCallback=null){
