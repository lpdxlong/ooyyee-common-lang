...
class ArrayUtils
{
     ...
     * @return array
     */
    public static function sort($array,$column,$type='ASC'){
    ...
    public static function column(array $array,$key,$field='*'){
     ...
     * @return array
     */
    public static function group(array $array, $key,$removeKey=false)
    {
        $grouped = array();
